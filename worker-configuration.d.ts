/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: d43819e920ae7e37a1fae9b2abfd3a88)
// Runtime types generated with workerd@1.20250823.0 2025-08-29 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		subscribe_mind: KVNamespace;
		TOKEN: "6000000";
		CLOSE_TOKEN: "xxx";
		ADVANCE_H: "3";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TOKEN" | "CLOSE_TOKEN" | "ADVANCE_H">> {}
}
